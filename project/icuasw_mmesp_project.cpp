...
rtems_task Init (uint32_t arg){
	...
	CCBKGTCExec	comp4(4, 11, EDROOMprioNormal, 1024, systemDeployment.GetComp4Memory());
	CCHK_FDIRMng	comp5(5, 14, EDROOMprioNormal, 1024, systemDeployment.GetComp5Memory());
