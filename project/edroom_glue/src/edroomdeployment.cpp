...
TEDROOMSignal CEDROOMSystemCommSAP::C4BKGTCExec_PTMChannelCtrl__C3TM_ChannelCtrl_PTMChannelCtrl3(TEDROOMSignal signalOut){
...
TEDROOMSignal CEDROOMSystemCommSAP::C3TM_ChannelCtrl_PTMChannelCtrl3__C4BKGTCExec_PTMChannelCtrl(TEDROOMSignal signalOut){
...
TEDROOMSignal CEDROOMSystemCommSAP::C2EPDManager_PBKGExecCtrl__C4BKGTCExec_PBKGExecCtrl(TEDROOMSignal signalOut){
...
TEDROOMSignal CEDROOMSystemCommSAP::C4BKGTCExec_PBKGExecCtrl__C2EPDManager_PBKGExecCtrl(TEDROOMSignal signalOut){
...
TEDROOMSignal CEDROOMSystemCommSAP::C2EPDManager_PHK_FDIRCtrl__C5HK_FDIRMng_PHK_FDIRCtrl(TEDROOMSignal signalOut){
...
TEDROOMSignal CEDROOMSystemCommSAP::C5HK_FDIRMng_PHK_FDIRCtrl__C2EPDManager_PHK_FDIRCtrl(TEDROOMSignal signalOut){
...
TEDROOMSignal CEDROOMSystemCommSAP::C5HK_FDIRMng_PTMChannelCtrl__C3TM_ChannelCtrl_PTMChannelCtrl2(TEDROOMSignal signalOut){
...
TEDROOMSignal CEDROOMSystemCommSAP::C3TM_ChannelCtrl_PTMChannelCtrl2__C5HK_FDIRMng_PTMChannelCtrl(TEDROOMSignal signalOut){
...
void CEDROOMSystemCommSAP::RegisterInterfaces(){
	...
	m_localCommSAP.RegisterInterface(1, mp_comp5->HK_FDIRCtrl, mp_comp5);
	m_localCommSAP.RegisterInterface(2, mp_comp5->TMChannelCtrl, mp_comp5);
	m_localCommSAP.RegisterInterface(3, mp_comp5->HK_FDIRTimer, mp_comp5);
...
void CEDROOMSystemCommSAP::SetLocalConnections(){
	...
	m_localCommSAP.Connect(mp_comp4->TMChannelCtrl, mp_comp3->TMChannelCtrl3, connections[0], 
					C4BKGTCExec_PTMChannelCtrl__C3TM_ChannelCtrl_PTMChannelCtrl3, 
					C3TM_ChannelCtrl_PTMChannelCtrl3__C4BKGTCExec_PTMChannelCtrl);
 
	m_localCommSAP.Connect(mp_comp2->BKGExecCtrl, mp_comp4->BKGExecCtrl, connections[1], 
					C2EPDManager_PBKGExecCtrl__C4BKGTCExec_PBKGExecCtrl, 
					C4BKGTCExec_PBKGExecCtrl__C2EPDManager_PBKGExecCtrl);
 
	m_localCommSAP.Connect(mp_comp2->HK_FDIRCtrl, mp_comp5->HK_FDIRCtrl, connections[2], 
					C2EPDManager_PHK_FDIRCtrl__C5HK_FDIRMng_PHK_FDIRCtrl, 
					C5HK_FDIRMng_PHK_FDIRCtrl__C2EPDManager_PHK_FDIRCtrl);
 
	m_localCommSAP.Connect(mp_comp5->TMChannelCtrl, mp_comp3->TMChannelCtrl2, connections[3], 
					C5HK_FDIRMng_PTMChannelCtrl__C3TM_ChannelCtrl_PTMChannelCtrl2, 
					C3TM_ChannelCtrl_PTMChannelCtrl2__C5HK_FDIRMng_PTMChannelCtrl);
